...
*/
{
  public static void main(String [] args)
     ...
     Scanner keyboard = new Scanner(System.in);
      ...
      q3 = keyboard.nextInt();
      /*q1=first quantity, q2=second quantity, q3=third quantity*/
     ...
     subTot1 = q1 * p1; subTot2 = q2 * p2; subTot3 = q3 * p3;
     subTotal = subTot1 + subTot2+ subTot3; total = subTotal * 1.625;
     /*tax rate of 6.25%*/
     
     System.out.println("Item" + "Quanity" + "Price");
     System.out.println(i1 + q1 + p1);
     System.out.println(i2 + q2 + p3);
     System.out.println(i3 + q3 + p3);
